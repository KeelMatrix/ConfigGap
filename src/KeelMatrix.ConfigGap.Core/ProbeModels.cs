...
public sealed class ProbeReport
{
    ...
    public string SupportedStaticResolution { get; set; } = "literals, const values, static concatenations, static interpolations, bounded local IConfigurationSection aliases without reassignment, and bounded same-compilation literal/const propagation through direct string-parameter helper forwarding (at most two hops)";
