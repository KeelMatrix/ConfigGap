...
The CI validation path also runs [`scripts/Test-PublicHistoryHygiene.ps1`](../scripts/Test-PublicHistoryHygiene.ps1), which fails closed when reachable commit messages contain prohibited attribution markers.
