...
- Literal reads through direct interface-typed receivers and statically resolved aliases to known root configuration properties or fields are preserved as supported static access.
